...
const ArrowRight = () => {
    return (
        <svg className={styles.icon_arrow} width="14" height="18" viewBox="0 0 11 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.802402 1.51303C1.62939 0.686035 2.97022 0.686036 3.79721 1.51303L9.78682 7.50264C10.6138 8.32963 10.6138 9.67045 9.78682 10.4974L3.79721 16.4871C2.97022 17.314 1.62939 17.314 0.802403 16.4871C-0.0245899 15.6601 -0.0245886 14.3192 0.802403 13.4922L5.29461 9.00004L0.802401 4.50783C-0.0245908 3.68084 -0.0245903 2.34002 0.802402 1.51303Z" fill="#BEC2CE"/>
        </svg>
    );
}
