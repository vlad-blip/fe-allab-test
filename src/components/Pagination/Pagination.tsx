...
export default function Pagination() {
    return (
        <nav className='flex items-center max-w-fit text-[1.6rem] xl:text-[2rem] font-bold bg-white text-blue-600 shadow-pagination rounded-2xl py-4 px-4 xl:px-10 mx-auto'>
